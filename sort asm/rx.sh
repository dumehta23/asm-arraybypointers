...
nasm -f elf64 -l sortbypointers.lst -o sortbypointers.o sortbypointers.asm
...
gcc -m64 -no-pie -o final input_array.o output_array.o sortbypointers.o director.o main.o
